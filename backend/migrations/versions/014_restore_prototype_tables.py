"""Restore prototype tables (pilot_assessments, pilot_assessment_definitions, content_reviews)

Revision ID: 014_restore_prototype_tables
Revises: 013_prune_prototype_tables
...
revision: str = '014_restore_prototype_tables'
down_revision: Union[str, None] = '013_prune_prototype_tables'
